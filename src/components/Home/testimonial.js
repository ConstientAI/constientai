      ...
      <Fade bottom>
        <div className="w-full flex flex-row justify-between align-middle bg-lightblack p-12 rounded-lg xxs:flex-col xs:flex-col sm:flex-row xxs:p-5 lg:p-12">
          <div className="w-3/4 xxs:w-full xs:w-full sm:w-3/4">
            <div className="font-poppins text-slate-800 font-semibold text-2xl leading-10 xxs:text-xs xxs:font-normal sm:text-2xl">
            ...
            <div className="mt-10">
              <h1 className="text-slate-800 text-3xl font-bold font-poppins">
                Ofelia Bashirian
              </h1>
              <h1 className="text-slate-800 text-sm font-semibold font-poppins opacity-50">
